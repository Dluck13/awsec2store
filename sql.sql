...
DROP SCHEMA IF EXISTS `ecommerce-store-dev`;
CREATE SCHEMA `ecommerce-store-dev`;

-- select the database
USE `ecommerce-store-dev` ;

-- create category table tbl_category
CREATE TABLE IF NOT EXISTS `ecommerce-store-dev`.`tbl_category` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT PRIMARY KEY,
  `category_name` VARCHAR(255) NULL DEFAULT NULL);

-- create book table tbl_product
CREATE TABLE IF NOT EXISTS `ecommerce-store-dev`.`tbl_product` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT PRIMARY KEY,
